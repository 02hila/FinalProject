...
export const agentTourSteps = [
    ...
    },
    {
        ...
        title: 'מחולל מודעות',
        content: 'לחץ כאן כדי ליצור מודעות חדשות עם הכלי המתקדם שלנו. אם חברה בחרה אותך לקמפיין, תוכל להשתמש במחולל המודעות כדי ליצור עבורה תוכן מתאים ומקצועי.',
        position: 'bottom',
        icon: '🎨'
    },
    {
        ...
        title: 'המודעות שלי',
        content: 'כאן תוכל לצפות בכל המודעות שיצרת, לעקוב אחר הסטטוס שלהן (מאושרות, ממתינות, נדחו).',
        position: 'bottom',
        icon: '🖼️'
    },
    {
        ...
        title: 'הקמפיינים שלי',
        content: 'צפה בכל הקמפיינים שחברות הקצו לך. כאן תוכל לראות את התקציב שהוקצה לכל קמפיין ולבקש הצעות מחיר במידה ומעוניין.',
        position: 'bottom',
        icon: '📊'
    },
    {
...
export const companyTourSteps = [
    ...
    },
    {
        ...
        title: 'הפרופיל שלי',
        content: 'ערוך את פרטי החברה שלך, עדכן את הלוגו, פרטי התקשרות ומידע נוסף שיוצג לסוכנים,המלצה להוסיף קישור לאתר על מנך שיווצר QR שאיתו תוכל לעקוב אחר ביצועי הפרסומת. ',
        position: 'bottom',
        icon: '👤'
    },
    {
