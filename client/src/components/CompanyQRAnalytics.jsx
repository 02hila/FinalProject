...
const CompanyQRAnalytics = () => {
  ...
  return (
    <div className="qr-analytics-page">
      <button className="back-button" onClick={() => navigate('/company-dashboard')}>
      ...
      <div className="analytics-container">
        <div className="analytics-header">
          <h1>
            <i className="fas fa-chart-line"></i> סטטיסטיקות QR של החברה
          </h1>
          <p>מעקב אחר סריקות ה-QR של כל המודעות שלך בזמן אמת</p>
        ...
        {overview && overview.totalQRs === 0 && (
          <div className="empty-state">
            ...
            <p>המודעות שלך עם QR יופיעו כאן ברגע שהסוכנים יתחילו לסרוק אותן</p>
          </div>
        )}
      </div>
    </div>
...
export default CompanyQRAnalytics;