                                        ...
                                        <div style={{ background: '#f8f9fa', padding: '20px', borderRadius: '12px', margin: '20px 0' }}>
                                            <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '15px', marginBottom: '15px' }}>
                                                <div style={{ textAlign: 'center', padding: '20px', background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', borderRadius: '10px', color: 'white' }}>
                                                    <div style={{ fontSize: '16px', marginBottom: '8px', opacity: 0.9 }}>סה"כ לתשלום</div>
                                                    <div style={{ fontSize: '32px', fontWeight: 'bold' }}>₪{Math.round(proposal.originalBudget + proposal.proposedBudget).toLocaleString()}</div>
                                                </div>
                                            </div>
