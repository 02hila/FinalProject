...
// --- 🎯 CORS FIX: Added explicit methods and headers to support Preflight (OPTIONS) ---
...
// Regular expression to allow all Vercel subdomains
...
    // 2. Check if the origin is in the explicit list or matches the Vercel regex
...
    }
  },
  // 🛑 הוספנו methods ו-allowedHeaders כדי לטפל בבקשת OPTIONS (Preflight)
...
app.use('/api/ads', adsRouter); // 💡 וודא שזה מכסה את GET /api/ads

// ===== FACEBOOK INTEGRATION (לא שוּנה) =====
// ... (קוד אינטגרציית פייסבוק כאן)

// ... (קוד generateAd, callGeminiWithRetry, createAdDesignOnServer וכו' כאן)
